...
int main(int argc, char** argv)
{
    ...
    std::ofstream file("/home/arna/Desktop/IITKGP/projects/PilotImage/abhinav_agarwalla-indicview-base-16b7206287f8/err.txt", std::ofstream::app);
	file << "Hello, starting 1,2,3\n";
	file.close();
